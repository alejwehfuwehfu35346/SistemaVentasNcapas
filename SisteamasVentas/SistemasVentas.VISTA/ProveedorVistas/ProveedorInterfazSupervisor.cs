...
{
    public partial class ProveedorInterfazSupervisor : Form
    {
        public ProveedorInterfazSupervisor()
        {
            InitializeComponent();
        }
        ProveedorBSS bss = new ProveedorBSS();
        private void ProveedorInterfazSupervisor_Load(object sender, EventArgs e)
        {
